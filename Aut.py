...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.pb_1.setGeometry(QtCore.QRect(50, 190, 91, 31))
        self.pb_1.setObjectName("pb_1")

        self.pb_2 = QtWidgets.QPushButton(Form)
        self.pb_2.setGeometry(QtCore.QRect(170, 190, 91, 31))
    ...
    def retranslateUi(self, Form):
        ...
        self.pb_1.setText(_translate("Form", "Вход"))
        self.pb_2.setText(_translate("Form", "Регистрация"))
